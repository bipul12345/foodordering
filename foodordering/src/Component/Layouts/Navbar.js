...
import { Button, Modal, ModalHeader, ModalBody, ModalFooter, 
  Container,NavItem,NavLink,UncontrolledDropdown,DropdownMenu,DropdownItem,DropdownToggle,Collapse,NavbarToggler,NavbarBrand,Nav,
  } from 'reactstrap';
    ...
    return (
      <div>
        <nav class="navbar navbar-expand-lg navbar-light" id="navbar">
          <a class="navbar-brand" href="/"><img id="logo" src={burg} />BhokLagyo</a>
      ...
      */}
            ...
            <form class="form-inline my-2 my-lg-0">
              <Button  color="light" variant="success" onClick={this.toggle}>SignIn</Button>{' '}
